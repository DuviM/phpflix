        ...
        <div class="single-movie-info">
          ...
          <div class="single-movie-rating">
            <div class="single-movie-rating-bar">
              <img src="./img/ratingStars.png" alt="" class="single-movie-rating-bar-stars">
              <span class="single-movie-rating-bar-note" style="width:<?= floor($data["vote_average"] * 10); ?>%;"></span>
            </div>
